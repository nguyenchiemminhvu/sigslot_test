...
namespace sigslot {
	...
	private:
		...
		typedef typename sender_set::const_iterator const_iterator; // vu.nguyenchiemminh added 'typename': with 'typedef' keyword only, the compiler assumes that const_iterator is a field
	public:
		has_slots()
		{
			;
